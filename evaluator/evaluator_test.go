...
func testIntegerObject(t *testing.T, obj object.Object, expected int64) bool {
	...
	if result.Value != expected {
		t.Errorf("object has wrong value. want=%d, but got=%d", expected, result.Value)
		return false
	}
...
func testBooleanObject(t *testing.T, obj object.Object, expected bool) bool {
	...
	if result.Value != expected {
		t.Errorf("object has wrong value. want=%t, but got=%t", expected, result.Value)
		return false
	}
...
`,
	...
	for _, tt := range tests {
		...
		if errObj.Message != tt.expectedMessage {
			t.Errorf("wrong error message. want %q, but got %q", tt.expectedMessage, errObj.Message)
		}
	}
}
...
func TestFunctionObject(t *testing.T) {
	...
	if len(fn.Params) != 1 {
		t.Fatalf("function has wrong parameters, got=%+v", fn.Params)
	}

	if fn.Params[0].String() != "x" {
		t.Fatalf("function parameter is not 'x', got=%q", fn.Params[0])
	}
